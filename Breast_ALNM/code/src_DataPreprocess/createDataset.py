...
# 训练index改成2，查看数据集改成1
index_to_label, label_to_index = utils.getClassIndices(brestDir_abs_index=0)
...
def generate_ds(datasetType="bmode", version ="version_normal",transforms="", batch_size=8, isShuffle=False, isAugment=False):
    ...
    Brease_Cancer_pytorch_path = get_path(0)  # 得到 Brease_Cancer_pytorch 的绝对路径

    # print("路径",Brease_Cancer_pytorch_path)
